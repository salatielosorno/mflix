...
;(async () => {
  try {
    ...
    const host = "mongodb+srv://m220student:m220password@mflix-eivdh.mongodb.net"
    ...
    const { modifiedCount } = await mflix.collection('movies').bulkWrite(moviesToMigrate, { ordered: false }) //"some bulk operation"
